...
public class Param_Collection {
    public static String getPaymentApiUrl() {
        if (VTConfig.VT_IsProduction) {
            return OLD_VERSION_PAYMENT_API;
        }
        return OLD_VERSION_PAYMENT_API_SANDBOX;
    }

    // productions
    public final static String OLD_VERSION_PAYMENT_API = "https://api.veritrans.co.id/v2/token";
    public final static String OLD_VERSION_PAYMENT_API_SANDBOX = "https://api.sandbox.veritrans.co.id/v2/token";
//    public static final String VT_CLIENT = "VT-client-rwC9mBTVVO8sihBb";

    //SANBOX
    public final static String PAYMENT_API_SANDBOX = "https://api.sandbox.veritrans.co.id";

    // VT_kEY PERSONAL for test
//    public static final String VT_CLIENT = "VT-client-nVzlgu-4tCkUS0dy";
    public static final String VT_CLIENT = "VT-client-Um5pn09FUP_cexxH";
    //    public static final String VT_CLIENT = "VT-client-O5RtWyo8Fk8CMTkr";
